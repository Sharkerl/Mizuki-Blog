...
export const zh_CN: Translation = {
	...
	[Key.footprintPostsAtLocation]: "篇文章在此地点",
	[Key.footprintZoomIn]: "放大",
	[Key.footprintZoomOut]: "缩小",
	[Key.footprintResetView]: "重置视野",

	// 设置面板
	[Key.settingsRadius]: "圆角大小",
	[Key.settingsSaturation]: "饱和度",
	[Key.settingsSidebarWidgets]: "侧栏组件",
	[Key.settingsLeftSidebar]: "左侧栏",
	[Key.settingsRightSidebar]: "右侧栏",
	[Key.widgetProfile]: "个人资料",
	[Key.widgetAnnouncement]: "公告",
	[Key.widgetTags]: "标签",
	[Key.widgetCardToc]: "文章目录",
	[Key.widgetSiteStats]: "站点统计",
	[Key.widgetCalendar]: "日历",
	[Key.widgetCategories]: "分类",
	[Key.widgetMusic]: "音乐",
	...
	// 书架页面
	[Key.bookshelf]: "书架",
	[Key.bookshelfSubtitle]: "我的书架与阅读清单",
	[Key.bookshelfRead]: "阅读",
	[Key.bookshelfEmpty]: "书架空空如也",
	[Key.bookshelfEmptyDesc]: "在 src/data/bookshelf.ts 中添加书籍，PDF 文件放入 public/files/books/",

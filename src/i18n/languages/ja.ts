...
export const ja: Translation = {
	...
	[Key.footprintPostsAtLocation]: "件の記事がこの場所に",
	[Key.footprintZoomIn]: "拡大",
	[Key.footprintZoomOut]: "縮小",
	[Key.footprintResetView]: "表示をリセット",
	...
	[Key.widgetProfile]: "プロフィール",
	[Key.widgetAnnouncement]: "お知らせ",
	[Key.widgetTags]: "タグ",
	[Key.widgetCardToc]: "目次",
	[Key.widgetSiteStats]: "サイト統計",
	[Key.widgetCalendar]: "カレンダー",
	[Key.widgetCategories]: "カテゴリー",
	[Key.widgetMusic]: "音楽",

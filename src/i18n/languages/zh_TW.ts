...
export const zh_TW: Translation = {
	...
	[Key.footprint]: "足跡",
	[Key.footprintSubtitle]: "文章足跡地圖",
	[Key.footprintEmpty]: "尚無位置資訊",
	[Key.footprintViewPost]: "查看文章",
	[Key.footprintPostsAtLocation]: "篇文章在此地點",
	[Key.footprintZoomIn]: "放大",
	[Key.footprintZoomOut]: "縮小",
	[Key.footprintResetView]: "重置視野",
	...
	[Key.widgetProfile]: "個人資料",
	[Key.widgetAnnouncement]: "公告",
	[Key.widgetTags]: "標籤",
	[Key.widgetCardToc]: "文章目錄",
	[Key.widgetSiteStats]: "站點統計",
	[Key.widgetCalendar]: "日曆",
	[Key.widgetCategories]: "分類",
	[Key.widgetMusic]: "音樂",

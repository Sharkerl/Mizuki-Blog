...
export const siteConfig: SiteConfig = {
	title: "Mizuki",
	subtitle: "Sharkerl's personal blog",
	...
	bilibili: {
		vmid: "3493075460557189", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				...
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/3493075460557189",
					external: true,
